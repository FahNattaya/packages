...
test.describe('AIS Shop Device Sale Customer Privilege SCN 001 Check Postpaid Pass', async () => {
    test('ระบบตรวจสอบสิทธิ์ของลูกค้าเบอร์ Postpaid ผ่าน', async ({ page }) => {
        ...
        await test.step('ผู้ใช้งานเลือก Campaign และ Trade', async () => {
            ...
            await productSelling.inputTextEmail('adsads@ads.team');
