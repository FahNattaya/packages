...
test.describe('AIS Shop Device Sale Customer Privilege SCN 002 Check Postpaid Fail', async () => {
    test('ระบบตรวจสอบสิทธิ์ของลูกค้าเบอร์ Postpaid ไม่ผ่าน ด้วยเงื่อนไขที่ลูกค้าใช้สิทธิ์เต็มไปแล้ว', async ({ page }) => {
