...
test.describe('AIS Shop Device Sale Service Care SCN 001 Customer Select Brand Apple and Select AIS CARE', async () => {
    test('ผู้ใช้งานเลือก Brand Apple กรณีลูกค้าสนใจเลือกซื้อ Service AIS CARE', async ({ page }) => {
        ...
        await test.step('ผู้ใช้งานเลือก Campaign และ Trade', async () => {
            ...
            await productSelling.clickTradeByIndex('2');
        ...
        await test.step('ผู้ใช้งานเลือก "PAY NOW" เมื่อตรวจสอบข้อมูล และเลือกวิธีการชำระเงิน', async () => {
            ...
            await paymentMethod.selectRadioFullPaidBank('0');
