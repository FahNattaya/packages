...
test.describe('AIS Shop Device Sale Service Care SCN 003 Customer Select Brand Apple Not Select Service', async () => {
    test('ผู้ใช้งานเลือก Brand Apple กรณีลูกค้าไม่สนใจเลือกซื้อ Service', async ({ page }) => {
        ...
        await test.step('ผู้ใช้งานเลือกสินค้าที่ลูกค้าต้องการซื้อ', async () => {
            ...
            await handsetList.selectBrandName(' iPhone 12 Pro 512GB ');
        ...
        await test.step('ผู้ใช้งานเลือก Campaign และ Trade', async () => {
            ...
            await productSelling.selectReason('1: ราคาเครื่องถูกอยู่แล้ว');
