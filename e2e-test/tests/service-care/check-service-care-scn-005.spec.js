...
test.describe('AIS Shop Device Sale Service Care SCN 005 Customer Select Brand Model Not Select Service', async () => {
    test('ผู้ใช้งานเลือก Brand ที่ไม่ใช่ Apple กรณีลูกค้าไม่สนใจเลือกซื้อ Service', async ({ page }) => {
